...
import com.x.pcpcustom.assemble.control.factory.SampleEntityClassNameFactory;
import org.apache.commons.lang3.StringUtils;

public class Business {

	//自定义应用配置文件名称，根据实际配置修改，文件要求为json格式
	private final static String CUSTOM_CONFIG_NAME = "o2oa_pcp";
	...
	//读取自定义应用配置
	public static JsonObject readConfig(String property) throws Exception{
